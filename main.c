...
int kisiSorgula(kisiBilgileri *, int);
int kayitOl(kisiBilgileri *);
int girisYap(kisiBilgileri *);
void uyeleriAktar(kisiBilgileri *);
void kitaplariAktar(kitapBilgileri *);
void kitaplariYedekle(kitapBilgileri *);
void uyeleriYedekle(kisiBilgileri *);
void kitaplariGoruntule(kitapBilgileri *);
void kitapAra(kitapBilgileri *);
void kitapEkle(kitapBilgileri *);
void uyeleriGoruntule(kisiBilgileri *);


int main() {
    // kitapListesi.txt - uyeListesi.txt
    ...
    printf("2.Sisteme giris yapmak istiyorsaniz 'G'\n");
    fflush(stdin);
    ch = getchar();
    if(ch == 'K' || ch == 'k'){
    ...
    if(uyeYetkisi == ogrenci){
        ...
        do{
            printf("1.Kitap eklemek istiyorsaniz 'E'\n");
            printf("2.Tum uyeleri goruntulemek istiyorsaniz 'U'\n");
            printf("3.Cikis yapmak istiyorsaniz 'Q' tuslayiniz\n");
            fflush(stdin);
            ch = getchar();
...
int kayitOl(kisiBilgileri *uyeListesi){
    ...
    printf("Sirasiyla ad-soyad bilginizi giriniz:\n");
    ...
    printf("Ogrenciyseniz 'O' calisansaniz 'C' giriniz\n");
    fflush(stdin);
    ch = getchar();
    if(ch == 'O'){
...
int girisYap(kisiBilgileri *uyeListesi){
    int ID, sifre, i;
    printf("Kutuphane ID bilginizi giriniz:\n");
    scanf("%d", &ID);
    printf("Sifrenizi giriniz:\n");
    scanf("%d",&sifre);
    ...
    while(!feof(kitapKayitlari)){
        for(i = 0 ;i<MAX_KITAP_SAYISI; i++){
            if(kitaplik[i].sayfaSayisi == 0){
                fscanf(kitapKayitlari,"%s\t%s\t%s\t%s\t%d\t%d", kitapAdi, yayinEvi, yazarAdi, yazarSoyadi,&kitaplik[i].kitapDurumu,&kitaplik[i].sayfaSayisi);
...
void kitapAra(kitapBilgileri *kitaplik){
    char kitapAdi[30];
    int i = 0;
    printf("Aramak istediginiz kitabin adinizi giriniz.");
    scanf("%s", kitapAdi);
...
void kitapEkle(kitapBilgileri *kitaplik){
    ...
    scanf("%s",yayinEvi);
    printf("Kitabin yazar adi ve soyadini sirasiyla giriniz:");
